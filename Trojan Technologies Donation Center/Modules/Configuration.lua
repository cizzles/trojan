...
local Configuration = {
	--> MAIN CONFIG	URATION
		...
		--> DONATION GAME PASSES
			...
			Game_Passes = {
			--> MAXIMUM OF 20 DONATIONS
				--> DEFAULT DONATIONS
					--> If you want to have a Default (Paid [Game Pass]) donation, type "Default" in between the parentheses
				...
				--> PAID [GAME PASS] DONATIONS
					--> If you want to have a Paid [Game Pass] donation, type "Paid" in between the parentheses
					--> You can replace {"Default", 0, 0}; with:
				...
				--> T-SHIRT DONATIONS
					--> If you want to have a Paid T-Shirt donation, type "T-Shirt" in between the parentheses
					--> You can replace {"Default", 0, 0}; with:
			...
			--> Replace 0000000000 with a Place ID if you want to teleport someone to a place after they have been ranked (after they have purchased a donation)
