...
local TPData = {
	...
	addons = Info.Add_Ons;
	mode = Config.Mode;
	gamepassranking = Config.Game_Pass_Ranking;
	onetimeranking = Config.One_Time_Ranking;
	unlimitedranking = Config.Unlimited_Ranking;
	gamepasses = Config.Game_Passes;
	...
	badgeranking = Config.Badge_Ranking;
