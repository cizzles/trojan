...
if Config then
	...
	local Icon = Background:WaitForChild("Icon")
	...
	elseif PlaceInfo.Creator.CreatorType == "User" then
		...
		if success then
			...
			for _, userInfo in ipairs(result) do
				...
				local Headshot, isReady = Players:GetUserThumbnailAsync(PlaceInfo.Creator.CreatorTargetId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size420x420)
